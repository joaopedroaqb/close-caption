...
model_path = r'C:\Users\joaop\Downloads\vosk-model-small-pt-0.3\vosk-model-small-pt-0.3'  # Modelo de espanhol como exemplo
        ...
        if recognizer.AcceptWaveform(data):
            ...
            if recognized_text:
                ...
                try:
                    ...
                    translation = translator.translate(recognized_text, src='pt', dest='en')
                    translated_caption_text += "\n" + translation.text
                except Exception as e:
...
while True:
    ...
    cv2.imshow('Portugês', caption_display_frame)
    ...
    cv2.imshow('Inglês', translation_display_frame)
